...
public class EmployeeIntegrationTest {
    ...
    void should_return_1_employee_when_get_employee_given_1_employee() throws Exception {
        ...
        mockMvc.perform(get("/employees/" + employee.getId()))
                .andExpect(status().isOk()).andExpect(jsonPath("name").value("lester"));
    }
    ...
    public void should_return_1_employee_when_add_employee_given_1_employee() throws Exception {
        ...
        String employeeContent = String.format("{\"name\":\"kiki\",\"gender\":\"male\",\"age\":88,\"companyId\":%d}", companyId);
        mockMvc.perform(post("/employees")
                .contentType(MediaType.APPLICATION_JSON)
                .content(employeeContent)).andExpect(status().isCreated());
    ...
    void should_return_1_employee_when_get_employee_by_page_given_page_1_size_1() throws Exception {
        ...
        mockMvc.perform(get("/employees?page=1&size=1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("numberOfElements")
                .value(1));
    }
